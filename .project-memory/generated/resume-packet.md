...
<!-- source_commit: 973a352 | inputs_hash: d95d38729353 | generated_at: 2026-08-17T15:49:32+00:00 -->

# Resume Packet

## Project
**breadcrumbs** — `.`  
branch `claude/crumb-kit-audit-review-x5b51n` · commit `973a352` · 5 uncommitted file(s)
...
- 973a352 memory: correct the MCP coverage trap — CI does test the [mcp] extra
- 69f3189 fix: guard stops punishing the behaviour it exists to encourage

## Active Decisions
- `dec_20260817_host-session-stores-a-digest-of-the-harness-session-id` — Session snapshots store sha256(session_id)[:12] in host_session. Only equality is ever tested, so the raw id is never needed.
...
- python -m unittest tests.test_hooks.HostSessionDigestTests
